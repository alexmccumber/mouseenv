...
MouseLungMetaData <- read_csv("PR8/MouseLungMetaData.csv")
```
...
ggline(weightgain, x = "time", y = "weight", group = "ID", facet.by = "Soil")+theme_fivethirtyeight()

weightgain %>%
  ggline(., x = "time", y= "weight", color = "Soil", add = "mean_se") + theme_fivethirtyeight()
```
